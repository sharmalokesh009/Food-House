...
export default function PrivacyPolicy(){
    ...
    <p>Welcome to <b> Food House</b>.</p>
    <p><b>Food House</b> (“us”, “we”, or “our”) operates <b>https://food-house-bb357.web.app/</b> (hereinafter referred to as <b>“Service”</b>).</p>
    <p>Our Privacy Policy governs your visit to <b>https://food-house-bb357.web.app/</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
    ...
    <br/>
    <p className="heading">2. <b>Definitions</b></p>
    <p><b>SERVICE</b> means the https://food-house-bb357.web.app/ website operated by Food House.</p>
    ...
    <br/>
    <p className="heading">3. <b>Information Collection and Use</b></p>
    <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
    <br/>
    <p className="heading">4. <b>Types of Data Collected</b></p>
    ...
    <br/>
    <p className="heading">5. <b>Use of Data</b></p>
    <p>Food House uses the collected data for various purposes:</p>
    ...
    <br/>
    <p className="heading">6. <b>Retention of Data</b></p>
    ...
    <br/>
    <p className="heading">7. <b>Transfer of Data</b></p>
    ...
    <p>Food House will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
    <br/>
    <p className="heading">8. <b>Disclosure of Data</b></p>
    ...
    <br/>
    <p className="heading">9. <b>Security of Data</b></p>
    <p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
    <br/>
    <p className="heading">10. <b>Your Data Protection Rights Under General Data Protection Regulation (GDPR)
    </b></p>
    <p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
    <p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>foodhousehelp@gmail.com</b>.</p>
    ...
    <br/>
    <p className="heading">11. <b>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</b></p>
    ...
    <p>0.4. users are able to change their personal information by emailing us at <b>foodhousehelp@gmail.com</b>.</p>
    <p>Our Policy on “Do Not Track” Signals:</p>
    <p>We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked.</p>
    <p>You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.</p>
    <br/>
    <p className="heading">12. <b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b></p>
    ...
    <p>To exercise your California data protection rights described above, please send your request(s) by email: <b>foodhousehelp@gmail.com</b>.</p>
    <p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>
    <br/>
    <p className="heading">13. <b>Service Providers</b></p>
    ...
    <br/>
    <p className="heading">14. <b>Analytics</b></p>
    <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
    <br/>
    <p className="heading">15. <b>CI/CD tools</b></p>
    <p>We may use third-party Service Providers to automate the development process of our Service.</p>
    <br/>                
    <p className="heading">16. <b>Behavioral Remarketing</b></p>
    <p>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>
    <br/>
    <p className="heading">17. <b>Payments</b></p><p>We may provide paid products and/or services within Service. In that case, we use third-party services for payment processing (e.g. payment processors).</p><p>We will not store or collect your payment card details. That information is provided directly to our third-party payment processors whose use of your personal information is governed by their Privacy Policy. These payment processors adhere to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands like Visa, Mastercard, American Express and Discover. PCI-DSS requirements help ensure the secure handling of payment information.</p>
    <br/>
    <p className="heading">18. <b>Links to Other Sites</b></p>
    ...
    <br/>
    <p className="heading">19. <b><b>Children’s Privacy</b></b></p>
    ...
    <br/>
    <p className="heading">20. <b>Changes to This Privacy Policy</b></p>
    <p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
    <p>We will let you know via email and/or a prominent notice on our Service, prior to the change becoming effective and update “effective date” at the top of this Privacy Policy.</p>
    <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
    <br/>
    <p className="heading">21. <b>Contact Us</b></p>
    <p>If you have any questions about this Privacy Policy, please contact us by email: <b>foodhousehelp@gmail.com</b>.</p>
    <p style={{marginTop:"5em" , fontSize:"0.7em"}}>This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created for <b>https://food-house-bb357.web.app/</b> by <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-11-11.</p>
